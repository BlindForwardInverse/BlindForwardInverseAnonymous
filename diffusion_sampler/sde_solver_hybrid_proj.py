...
class Heun2ndSamplerHybridProj(nn.Module):
    ...
    def forward_with_operator(self, _operator, y=None, y_wav=None, c_embedding=None, t_embedding=None):
        x_next = self.timesteps[0] * torch.randn_like(y_wav)
