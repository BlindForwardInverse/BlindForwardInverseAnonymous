...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    ...
    --no-randomize_params\
    --save_dir /ssd4/doyo/test_set_large/single_effects\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    ...
    --randomize_params\
    --seed 0\
    --save_dir /ssd4/doyo/test_set_large/single_effects_rand_param\
    --recording_envs vctk1\
    --render_effect_types single\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    --num_audio_per_afx 100\
    --randomize_params\
    --save_dir /ssd4/doyo/test_set_large/single_effects_rand_param_2\
    --seed 42\
    --recording_envs vctk1\
    --render_effect_types single\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    --num_audio_per_afx 100\
    --randomize_params\
    --save_dir /ssd4/doyo/test_set_large/multi_effects\
    --recording_envs vctk1\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    --num_audio_per_afx 100\
    --randomize_params\
    --save_dir /ssd4/doyo/test_set_large/single_effects_multi_env\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    --num_audio_per_afx 100\
    --randomize_params\
    --save_dir /ssd4/doyo/test_set_large/single_effects_multi_rand_param\
    --seed 423\
    --recording_envs vctk1 vctk2 daps\
    --render_effect_types single\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    --num_audio_per_afx 100\
    --randomize_params\
    --save_dir /ssd4/doyo/test_set_large/multiple_effects_multi_env\
    --recording_envs vctk1 vctk2 daps\
    --render_effect_types monolithic complex\
    --num_monolithic_graphs 50\
    --num_complex_graphs 50\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    --num_audio_per_afx 100\
    --randomize_params\
    --save_dir /ssd4/doyo/test_set_large/cross_domain_single\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    --num_audio_per_afx 100\
    --randomize_params\
    --save_dir /ssd4/doyo/test_set_large/cross_domain_multiple\
    --modality cross_modal\
    --render_effect_types monolithic complex\
    --num_monolithic_graphs 50\
    --num_complex_graphs 50\
...
CUDA_VISIBLE_DEVICES=$GPU_NUM python3 prerender_valid.py\
    ...
    --randomize_params\
    --seed 423\
    --save_dir /ssd4/doyo/test_set_large/cross_domain_single_rand_param\
    --modality cross_modal\
    --render_effect_types single\
